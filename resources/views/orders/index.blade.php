                            ...
                            <a href="{{ route('orders.show', $order->id) }}">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle mb-2"><span class="card-attribute">Category:</span>
                                            {{ $order->product->category->name }}</h6>
                                        <p class="card-text"><span class="card-attribute">Quantity:</span>
                                            {{ $order->quantity }}</p>
                                        <p class="card-text"><span class="card-attribute">Product Price:</span>
                                            {{ $order->product->price }}</p>
                                        <p class="card-text"><span class="card-attribute">Total Price:</span>
